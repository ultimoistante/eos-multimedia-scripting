#include "Matrix3.h"
    ...
    Vector3 Matrix3::GetColumn (size_t iCol) const
    {
        ...
        if(iCol < 0 || iCol > 3)
          {
          fprintf(stderr, "Vector3 Matrix3::GetColumn(size_t iCol) - ERROR: iCol out of range!\n");
          return Vector3::ZERO;
          }
    ...
    void Matrix3::SetColumn(size_t iCol, const Vector3& vec)
    {
        ...
        if(iCol >= 0 && iCol < 3)
          ...
          fprintf(stderr, "void Matrix3::SetColumn(size_t iCol, const Vector3& vec) - ERROR: iCol out of range!\n");
    }
    //-----------------------------------------------------------------------
